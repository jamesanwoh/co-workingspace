                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade active show" id="account" role="tabpanel" aria-labelledby="account-tab">
                                        <form class="needs-validation user-add" action="{{url('role-updateUser/'.$user_role->id)}}" method="post">
                                            {{csrf_field()}}
                                            @method('put')
                                            ...
                                            <div class = "form-group row">
                                                ...
                                                <select name="role_as" class="form-control col-xl-8 col-md-7" required>
