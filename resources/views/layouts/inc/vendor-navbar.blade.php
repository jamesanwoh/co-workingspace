    ...
    <div class="page-main-header">
        <div class="main-header-right row">
            <div class="main-header-left d-lg-none">
                <div class="logo-wrapper"><a href="{{ route('home') }}"><img class="blur-up lazyloaded" src="{{asset('/assets/images/dashboard/multikart-logo.png')}}" alt=""></a></div>
            </div>
            ...
            <div class="nav-right col">
                <ul class="nav-menus">
                    ...
                    <li class="onhover-dropdown">
                        <div class="media align-items-center"><img class="align-self-center pull-right img-50 rounded-circle blur-up lazyloaded" src="{{asset('uploads/profile/'.Auth::user()->image)}}" alt="header-user">
                            <div class="dotted-animation"><span class="animate-circle"></span><span class="main-circle"></span></div>
                        </div>
                        <ul class="profile-dropdown onhover-show-div p-20 profile-dropdown-hover">
                            <li><a href="{{url('/')}}"><i data-feather="home"></i>Home</a></li>
                            <li><a href="{{url('editUser')}}"><i data-feather="user"></i>Edit Profile</a></li>
