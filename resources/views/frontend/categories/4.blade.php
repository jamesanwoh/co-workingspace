                ...
                <div class="row">
                    <div class="col-sm-3 collection-filter">
                                ...
                                <div class="collection-collapse-block-content">
                                    <div class="collection-brand-filter">
                                        <ul class="category-list">
                                            ...
                                            <li class="current"><a href="{{url('d')}}">private work space</a></li>
                                            <li><a href="{{url('e')}}">minmal/bare bone</a></li>
                                            <li><a href="{{url('f')}}">shared space/ subline</a></li>
                                            <li><a href="{{url('g')}}">Industrial specification/ specialized</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="theme-card">
                            <h5 class="title-border">new offices</h5>
                                    ...
                                    <div class="collection-product-wrapper">
                                        ...
                                        <div class="product-wrapper-grid product-load-more">
                                            <div class="row margin-res">
                                                ...
                                                @foreach ($categoryd as $catogriesd)
                                                <div class="col-xl-3 col-6 col-grid-box">
                                                    <div class="product-box">
                                                        <div class="img-wrapper">
                                                            <div class="front">
                                                                <a href="#">
                                                                    <img name="image" src="{{asset('uploads/files')}}/{{$catogriesd->image}}"  alt="" class="img-fluid blur-up lazyload bg-img">
                                                                </a>
                                                            </div>
                                                            <div class="back">
