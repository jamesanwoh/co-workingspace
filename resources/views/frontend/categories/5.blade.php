                                ...
                                <div class="collection-collapse-block-content">
                                    <div class="collection-brand-filter">
                                        <ul class="category-list">
                                            ...
                                            <li class="current"><a href="{{url('e')}}">minmal/bare bone</a></li>
                                    ...
                                    <div class="collection-product-wrapper">
                                        ...
                                        <div class="product-wrapper-grid product-load-more">
                                            <div class="row margin-res">
                                                @foreach ($categorye as $catogriese)
                                                <div class="col-xl-3 col-6 col-grid-box">
                                                    <div class="product-box">
                                                        <div class="img-wrapper">
                                                            <div class="front">
                                                                <a href="#">
                                                                    <img name="image" src="{{asset('uploads/files')}}/{{$catogriese->image}}"  alt="" class="img-fluid blur-up lazyload bg-img">
                                                                </a>
                                                            </div>
                                                            <div class="back">
