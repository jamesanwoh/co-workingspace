                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6 service-block">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4>work space reservation/bookings</h4>
                    ...
                    <div class="col-lg-3 col-sm-6 service-block">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4>Longterm working space booking</h4>
                                {{-- <p>new online special festival offer</p> --}}
                            </div>
                        </div>
                    </div>
    ...
    <!-- service layout 3 ends -->

    <!--four row product slider -->

    <div class="title1 section-t-space">
        <h4> sleek and exquist </h4>
        <h2 class="title-inner1">Our workspace categories</h2>
    </div>
            ...
            <div class="row partition3 partition_3">
                <div class="col-lg-4 ">
                    <div class="theme-card card-border">
                        <h5 class="title-border">High End / Full Service</h5>
                        <div class="offer-slider slide-1">
                            @foreach($servicesb as $services)
                            <div>
                                <div class="media">
                                    {{-- <a href="product-page(no-sidebar).html"> --}}
                                        <a class="nav-link" href="{!! url('details/'.$services->id)!!}"> <img class="img-fluid blur-up lazyload"
                                            src="{{asset('uploads/files')}}/{{$services->image}}" alt=""></a>
                                ...
                                <div class="media">
                                    {{-- <a href="product-page(no-sidebar).html"> --}}
                                        ...
                                        <img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/1.png" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                ...
                <div class="col-lg-4 ">
                    <div class="theme-card card-border">
                        <h5 class="title-border">Shared Space / Subline</h5>
                        <div class="offer-slider slide-1">
                            @foreach($servicesf as $services)
                            <div>
                                <div class="media">
                                    {{-- <a href="product-page(no-sidebar).html"> --}}
                                        <a class="nav-link" href="{!! url('details/'.$services->id)!!}"> <img class="img-fluid blur-up lazyload"
                                ...
                                <div class="media">
                                    {{-- <a href="product-page(no-sidebar).html"> --}}
                                        <a class="nav-link" href="{{ route('login') }}"> <img class="img-fluid blur-up lazyload"
                                            src="{{asset('uploads/files')}}/{{$services->image}}" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                ...
                <div class="col-lg-4 ">
                    <div class="theme-card card-border">
                        <h5 class="title-border">Private Work Space</h5>
                        <div class="offer-slider slide-1">
                            @foreach($servicesd as $services)
                            <div>
                                <div class="media">
                                    {{-- <a href="product-page(no-sidebar).html"> --}}
                                        <a class="nav-link" href="{!! url('details/'.$services->id)!!}"> <img class="img-fluid blur-up lazyload"
    ...
    <section class="ratio_square section-b-space">
        <div class="container">
            <div class="row partition3 partition_3">
                <div class="col-lg-4">
                    <div class="theme-card card-border">
                        <h5 class="title-border">Co-operate / Professional</h5>
                        <div class="offer-slider slide-1">
                            @foreach($servicesc as $services)
                            <div>
                                <div class="media">
                                    {{-- <a href="product-page(no-sidebar).html"> --}}
                                        <a class="nav-link" href="{!! url('details/'.$services->id)!!}"> <img class="img-fluid blur-up lazyload"
                ...
                <div class="col-lg-4">
                    <div class="theme-card card-border">
                        <h5 class="title-border">conventional/ Open conventional</h5>
                        <div class="offer-slider slide-1">
                            @foreach($servicesa as $services)
                            <div>
                                <div class="media">
                                    {{-- <a href="product-page(no-sidebar).html"> --}}
                                        <a class="nav-link"  href="{!! url('details/'.$services->id)!!}"> <img class="img-fluid blur-up lazyload"
                                ...
                                <div class="media">
                                    {{-- <a href="product-page(no-sidebar).html"> --}}
                                        <a class="nav-link" href="{!! url('details/'.$services->id)!!}">
                                        <img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/1.png" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                ...
                <div class="col-lg-4">
                    <div class="theme-card card-border">
                        <h5 class="title-border">Industry Specification / Specializied</h5>
                        <div class="offer-slider slide-1">
                            @foreach($servicesg as $services)
                            <div>
                                <div class="media">
                                    {{-- <a href="product-page(no-sidebar).html"> --}}
                                        <a class="nav-link" href="{!! url('details/'.$services->id)!!}"> <img class="img-fluid blur-up lazyload"
