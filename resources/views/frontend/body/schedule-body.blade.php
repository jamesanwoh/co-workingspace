                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="product-slick">
                                        <div><img name="image" src="{{asset('uploads/files')}}/{{$details->image}}" width="350px" height="350px" alt=""
                                ...
                                <div class="col-lg-6 rtl-text">
                                    <div class="product-right">
                                        ...
                                        <h4><span>{{$details->RoomSize}}</span></h4>
                                        <h3>{{$details->Price}}</h3>
                                        <div class="product-description border-product">
                                            <h6 class="product-title size-text">Location <span><a href=""
                                                        data-toggle="modal" data-target="#sizemodal">{{$details->location}}
                                                        </a></span></h6>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Google view location
                                                            </h5>
                                                        ...
                                                        <div class="modal-body"><iframe
                                                            ...
                                                            allowfullscreen width="100%" height="300" style="border:none;"></iframe></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="product-buttons"> <a href="{{ url('/') }}" class="btn btn-solid">Home</a>&nbsp;&nbsp;
                                                 <a href="{{ url('UserRequest') }}" class="btn btn-solid">book now</a></div>
                                ...
                                <div class="collection-collapse-block-content">
                                    <div class="collection-brand-filter">
                                        <ul class="category-list">
                                            <li><a href="{{url('a')}}">conventional/ open-conventional</a></li>
                                            <li><a href="{{url('b')}}">high-end/ full service</a></li>
                                            <li><a href="{{url('c')}}">co-operate/ professional</a></li>
                                            <li><a href="{{url('d')}}">private work space</a></li>
                                            <li><a href="{{url('e')}}">minmal/bare bone</a></li>
                                            <li><a href="{{url('f')}}">shared space/ subline</a></li>
                                            <li><a href="{{url('h')}}">Industrial specification/ specialized</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
