    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-section"><img src="../assets/images/about/111.jpg"
                        ...
                        <div>
                            <div class="media">
                                <div class="text-center">
                                    <img src="../assets/images/121.jpg" alt="#">
                                    <h5>Mark Jecno</h5>
                                    <h6>Designer</h6>
                                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="team-4">
                        ...
                        <div>
                            <div>
                                <img src="../assets/images/team/2.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
